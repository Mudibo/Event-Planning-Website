            ...
            <div id = "our-summary" className="our-summary">
                ...
                <div id="Our Story" className="our-story">
                    ...
                    <p>
                        ...
                        {showMoreOurStory && (
                            <p>Our journey started with a small team and a big dream. Over the years, we've expanded our services and our team, but our commitment to quality and client satisfaction remains unchanged.</p>
                        )}
                    </p>
                ...
                <div id="what-we-do" className="what-we-do">
                    ...
                    {showMoreWhatWeDo && (
                        <p>ur services include venue selection, catering, decoration, entertainment, and more. We work closely with our clients to ensure every event is personalized and perfect.</p>
                    )}
                    </p>
                ...
                <div id="why-choose-us" className="why-choose-us">
                    ...
                    {showMoreWhyChooseUs && (
                        <p>We pride ourselves on our exceptional service and our ability to handle any event, no matter the size or complexity. Let us help you create a memorable event that will be cherished for years to come.</p>
                    )}
                    </p>
                ...
                <div id="create-something" className="create-something">
                    ...
                    <p>
                        ...
                        {showMoreCreateSomething && (
                            <p> Reach out to us via our various social media platforms. With our expertise, attention to detail, and passion for creating memorable events, we ensure that every aspect of your event is meticulously planned and flawlessly executed, leaving you free to enjoy every moment. Start planning with us today! We are excited to work with you and make your vision a reality. Whether you have a clear idea or need some inspiration, our team is here to guide you every step of the way.</p>
                        )}
                    </p>
